...
% breve parágrafo sobre a competência I na tabela geral, falando qual a melhor rede dentre as treinadas. falar que a figura abaixo vai mostrar a matriz de confusão

\begin{figure}[H]
    \centering
    \resizebox{0.75\textwidth}{!}{\input{../figuras/matrizes/matrix_c1}}
    \caption{Matriz de confusão do modelo de correção automática da competência I.}
    \label{fig:eval-c1-confusion-matrix}
\end{figure}

% interpretação rápida e concisa da matriz de confusão
