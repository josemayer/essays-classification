...
% Pacote tabularx, que define o ambiente tabularx, que é como tabular,
% mas permite especificar uma largura para a tabela e colunas com largura
% variável (X). A largura total da tabela é dividida entre as colunas X.
\usepackage{tabularx}
